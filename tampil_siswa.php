...
<body>
    ...
    <table class="table table-hover table-striped">
        <thead>
            <tr>
                <th>NO</th><th>ID SISWA</th><th>NAMA SISWA</th><th>TANGGAL LAHIR</th>
...
$qry_siswa=mysqli_query($conn,"select * from siswa join kelas on kelas.id_kelas=siswa.id_kelas");
            ...
            $no++;?>
<tr>              <td><?=$no?></td>
<td><?=$data_siswa['id_siswa']?></td><td><?=$data_siswa['nama_siswa']?></td>
 <td><?=$data_siswa['tanggal_lahir']?></td> <td><?=$data_siswa['alamat']?></td>
 <td><?=$data_siswa['gender']?></td> <td><?=$data_siswa['username']?></td> 
